...
public class MyFriendsController implements Observer {
    ...
    private void initFriends(){
        firstLoadedUsersPage = service.friendsOfAnUser(new PageableImpl<>(1, 2), service.findOneByEmail(service.getCurrentEmail()));
        secondLoadedUsersPage = service.friendsOfAnUser(new PageableImpl<>(2, 2), service.findOneByEmail(service.getCurrentEmail()));
        setFriendModel();
    }
    ...
    void add() {
        ...
        try {
            ...
            if (selected != null) {
                ...
                if (!friendship) {
                    ...
                    try {
                        ...
                        MessageAlert.showErrorMessage(null, "Already sent. It may be pending or declined ...");
                    }
                    if (ok)
            ...
            MessageAlert.showMessage(null,Alert.AlertType.INFORMATION,"Enter valid data !","Not sent");
        }
    }
